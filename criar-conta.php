            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/logo-omni.png" alt="">
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">Eu aceito <a href="#">Os termos e condições</a></label>
                        <div class="invalid-feedback">Clica na caixa, mano!</div>
                      </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Já tem uma conta? <a href="pages-login.html">Entrar</a></p>
                    </div>
                  </form>
